...
@section('web_content')
    <!-- Navbar & Hero End -->
@php
$toursites = App\Models\Toursite::all();
$toursites_count = App\Models\Toursite::count();
@endphp
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">This website enables you to travel any Tour site in Tanzania with ease  from book travelling.</p>
                    <p class="mb-4"> To the Booking hotel rooms foods, and all acomodations</p>
                    <div class="row gy-2 gx-4 mb-4">
                        ...
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Consistent Transportations</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Get Over {{$toursites_count ?? '0'}} Tourist sites to Travel </p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>24/7 Service</p>
                        </div>
                    </div>
                    <a class="btn btn-primary py-3 px-5 mt-2" href="{{route('tour.sites')}}">Read More</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="booking p-5">
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white">
                        ...
                        <p class="mb-4">You can book Through any Destination you like, and we can arrage best Safari for you</p>
                        <p class="mb-4">To ensure That you can rack and manage your booking you can simply Sigh up and Join our quest.</p>
                        <a class="btn btn-outline-light py-3 px-5 mt-2" href="">Sign up</a>
                    </div>
                    <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select class="form-select bg-transparent" id="select1">
                                             @forelse($toursites as $toursite)
                                            <option value="{{$toursite->id}}">{{$toursite->name}}</option>
                                            @empty
                                            <option value="">No toursite yet</option>
                                            @endforelse
                                        </select>
            ...
            <div class="row gy-5 gx-4 justify-content-center">
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative border border-primary pt-5 pb-4 px-4">
                        ...
                        <p class="mb-0">You can choose Through any Vacation site which are available in our site and we can surely arrange tour for you</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="position-relative border border-primary pt-5 pb-4 px-4">
                        ...
                        <hr class="w-25 mx-auto bg-primary mb-1">
                        <hr class="w-50 mx-auto bg-primary mt-0">
                        <p class="mb-0">After That we Will Give you Total cost Required for your trip. Just pay To proceed</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="position-relative border border-primary pt-5 pb-4 px-4">
                        ...
                        <h5 class="mt-4">Fly And Enjoy</h5>
                        <hr class="w-25 mx-auto bg-primary mb-1">
                        <hr class="w-50 mx-auto bg-primary mt-0">
                        <p class="mb-0">Then when the day reaches , You can Travel with easy with no complications and With time and cost saved.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Testimonial Start -->
    {{-- this was supporsed to be testimonial part  --}}
    <!-- Testimonial End -->
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-sm-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@toutanzania.com</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Tour and Travel</a>, All Right Reserved.

                    
                        Designed By <a class="border-bottom" href="#">Giva A Mwakamela</a>
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        <div class="footer-menu">
                            <a href="">Home</a>
                            <a href=" {{route('tour.sites')}} ">Tour sites</a>
                            <a href="">Sign up</a>
                            <a href="">contact us</a>
                        </div>
                    </div>
