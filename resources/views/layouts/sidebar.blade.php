					...
					<ul>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-hotel"></i> <span> Accomodations </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
								...
								<li><a href="{{ route('all-accomodations.create') }}"> add </a></li>

								@can('view-any', App\Models\Accomodationimages::class)
                                    <li><a href="{{ route('all-accomodationimages.index') }}"> view images</a></li>
								<li><a href="{{ route('all-accomodationimages.create') }}"> add image</a></li>
