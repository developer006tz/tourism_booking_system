        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="{{route('tour_site.about')}}" class="nav-item nav-link">About</a>
                    <a href="{{route('tour_site.services')}}" class="nav-item nav-link">Services</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            @php
                                $attractions = App\Models\Attractions::all();
                            @endphp
                            @forelse ($attractions as $attraction)
                                <a href="#" class="dropdown-item">{{$attraction->name}}</a>
                            @empty
                                <a href="#" class="dropdown-item">No Attractions</a>
                            @endforelse
                        </div>
                    </div>
